...
export const DEFAULT_STATE = {
  ...
  attendAsk: false, // опрос «Ты на паре?» через 10 минут после начала: по умолчанию выключен,
                    // иначе при 4 парах в день приходит 10 уведомлений; включается в настройках
  notifAskedAt: 0,  // когда последний раз показывали экран «Включить напоминания?»
  lessonData: {},
